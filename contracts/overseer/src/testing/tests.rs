...
fn update_config() {
    ...
    let msg = ExecuteMsg::UpdateConfig {
        ...
        kpt_purchase_factor: Some(Decimal256::percent(10)),
    ...
    assert_eq!(Decimal256::percent(10), config_res.kpt_purchase_factor);
...
fn execute_epoch_operations() {
    ...
    store_epoch_state(
        ...
        &EpochState {
            ...
            prev_atoken_supply: Uint256::from_str("1000000").unwrap(),
...
fn update_epoch_state() {
    ...
    assert_eq!(
        ...
        EpochState {
            ...
            prev_atoken_supply: epoch_state_response.atoken_supply,
