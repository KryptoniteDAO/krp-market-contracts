...
AssetInfo is a convenience wrapper to represent whether a token is the native one (from a specific chain, like SEI for Sei) or not. It also returns the contract address of that token.
